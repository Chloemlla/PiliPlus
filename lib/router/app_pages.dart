import 'package:pili_plus/pages/article/view.dart';
import 'package:pili_plus/pages/article_list/view.dart';
...
import 'package:pili_plus/pages/dynamics_topic/view.dart';
import 'package:pili_plus/pages/dynamics_topic_rcmd/view.dart';
import 'package:pili_plus/pages/fan/view.dart';
import 'package:pili_plus/pages/fav/view.dart';
import 'package:pili_plus/pages/fav_create/view.dart';
import 'package:pili_plus/pages/fav_detail/view.dart';
import 'package:pili_plus/pages/fav_search/view.dart';
import 'package:pili_plus/pages/follow/view.dart';
import 'package:pili_plus/pages/follow_search/view.dart';
import 'package:pili_plus/pages/follow_type/follow_same/view.dart';
import 'package:pili_plus/pages/follow_type/followed/view.dart';
import 'package:pili_plus/pages/history/view.dart';
import 'package:pili_plus/pages/history_search/view.dart';
...
import 'package:pili_plus/pages/match_info/view.dart';
import 'package:pili_plus/pages/member/view.dart';
import 'package:pili_plus/pages/member_dynamics/view.dart';
import 'package:pili_plus/pages/member_guard/view.dart';
import 'package:pili_plus/pages/member_profile/view.dart';
import 'package:pili_plus/pages/member_search/view.dart';
import 'package:pili_plus/pages/member_upower_rank/view.dart';
import 'package:pili_plus/pages/member_video_web/archive/view.dart';
import 'package:pili_plus/pages/member_video_web/season_series/view.dart';
import 'package:pili_plus/pages/msg_feed_top/at_me/view.dart';
import 'package:pili_plus/pages/msg_feed_top/like_detail/view.dart';
import 'package:pili_plus/pages/msg_feed_top/like_me/view.dart';
import 'package:pili_plus/pages/msg_feed_top/reply_me/view.dart';
...
import 'package:pili_plus/pages/search_result/view.dart';
import 'package:pili_plus/pages/search_trending/view.dart';
...
import 'package:pili_plus/pages/settings_search/view.dart';
import 'package:pili_plus/pages/space_setting/view.dart';
import 'package:pili_plus/pages/sponsor_block/view.dart';
